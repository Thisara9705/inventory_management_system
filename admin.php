...
?>              
              ...
              <button type="ebutton" class="btn btn-success" data-toggle="modal" data-target="#profileModal"><i class="fa fa-edit" style="margin-right: 10px;">&nbsp;</i>Edit Profile</button>
<?php  
      }
?>              
            </div>
...
<!-- orders -->
        <div class="col-md-8">
         <div class="card shadow" style="width:100%; height: 100%; background-image: url('img/logo/fotter.jpg');">
         	<i class="fas fa-shopping-cart" style="font-size: 6rem; margin: auto; margin-top: 20px; margin-bottom: 30px;"></i>
            <div class="card-body">
       ...
       <div class="col-md-4">
         <div class="card shadow" style="width:100%; height: 100%; background-image: url('img/logo/fotter.jpg');">
            ...
            <div class="card-body">
              ...
              <h6 class="card-text">Here you can Add and Manage Users...</h6>
              <input type="submit" class="btn btn-success"  value="Add" data-toggle="modal" data-target="#add_user" style="margin: 5px;">
              <a href="manage_users.php"><input type="submit" class="btn btn-success"  value="Manage" style="margin: 5px;"></a>                          
            </div>
          </div>
       </div>
     </div> 
